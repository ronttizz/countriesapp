      ...
      <div className="countryinfo">
        <div className="leftpanel">
          <img
            ...
            className="bigflag"
          />
          <small>{"Flag of " + country?.name?.official}</small>
          {country?.coatOfArms?.svg ? (
            <>
              ...
              />
              <small>{"Coat of Arms of " + country?.name?.official}</small>
            </>
          ) : (
            ""
          )}
        ...
        <div className="rightpanel">
          <ul className="infolist">
            ...
            <li>
              ...
              {Object.values(country?.currencies || {}).map((cur, i) => (
                <span key={i}>{(i ? ", " : "") + cur.name}</span>
              ))}
            </li>
            <li>
              <svg
